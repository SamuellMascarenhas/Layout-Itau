        ...
        <section className=" relative w-full h-[965px]">
            <Container>
                <div className="flex-1 max-w-[594px] pt-32">
                    ...
                    <li className="flex itemns-center gap-9 pb-9 border-b-[1px] border-opacity-gray">
                        <div className="w-7 h7 flex itemns-center justify-center">
                    ...
                    <li className="flex itemns-center gap-9 ">
                        <div className="w-7 h7 flex itemns-center justify-center">
